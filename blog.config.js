...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ShenDu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平凡的普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.135200.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '慎独, 博客', // 网站关键词 英文逗号隔开
